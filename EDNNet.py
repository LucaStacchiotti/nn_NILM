...
from SelfAttention import BertSelfAttention
# Per implementare la rete

########### DECODER ########
#Comprende il MHAttention
class myDecoder(nn.Module):
  def __init__(
      ...
      h,
        ...
        #self.layer1=nn.MultiheadAttention(embed_dim=in_channels,num_heads=h,batch_first=True)
  ...
  def forward(self, x):
        ...
        out=torch.movedim(out,1,2)
        out = self.layer2(out)
        return out
        
############ EDNnet ############
#Codice modificato della Convtanet per renderla come l'EDNnet dell'articolo
